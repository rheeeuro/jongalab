...
#   strict       : 통계 유의성 요구(ci_low>0 + t_days≥t분포임계값) + 판정 일정(발견→확인창)
...
# 초과수익을 눈으로 확인) · 월 승격 상한. 안정성 조건(ci_low·t_days)은 experimental 에서 면제
# 상태를 유지하기로 확인했다(2026-08-04) — 즉 지금 게이트는 '10거래일+ 표본에서 평균 양수'다.
