...
_DEFAULTS = {
    ...
    "SCORE_LEADER_BONUS": 3,
    "SCORE_EXTRA_SUPPLY_DAY_BONUS": 3,
    "SCORE_PROGRAM_BUY_BONUS": 0.0,
    # 뉴스 재료 가점 — 기본 0(표시·튜닝 전용, 종합점수 무영향). 주간 튜너가 성과 따라 상향 가능.
    "SCORE_NEWS_BONUS": 0.0,
    # 당일 등락률 항 (2026-07-03 실증 반영) — 스윗스팟 가점 / 과열 감점. *_PCT 는 비튜닝 상수.
    "SCORE_CHANGE_BAND_BONUS": 10.0,
    "SCORE_OVERHEAT_PENALTY": 10.0,
    "CHANGE_BAND_MIN_PCT": 2.0,
    "CHANGE_BAND_MAX_PCT": 12.0,
    "OVERHEAT_CHANGE_PCT": 15.0,
    "EXCLUDE_KEYWORDS": [
...
SCORE_WEIGHT_KEYS = [
    ...
    "CONTENT_SCORE_MAX",
    "SCORE_NEWS_BONUS",
    "SCORE_CHANGE_BAND_BONUS",
    "SCORE_OVERHEAT_PENALTY",
]
