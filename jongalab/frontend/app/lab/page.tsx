        ...
        <details className="rounded-2xl border border-indigo-100 bg-indigo-50/50 px-4 py-3 dark:border-indigo-500/20 dark:bg-indigo-500/5">
          ...
          <div className="mt-3 space-y-2.5 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
            ...
            <p>
              ...
              반영됩니다. 카드 하단 진행바는 <b>서로 다른 거래일 10일</b>을 채웠는지만 보여줍니다 —
              같은 날 여러 종목은 시장 흐름에 함께 움직여서, 종목 수가 아무리 많아도 날이 적으면 우연을
              걸러낼 수 없기 때문입니다. <b>진행바가 다 차도 바로 통과는 아닙니다.</b> 거래일을 채운
              뒤에는 회당 순수익이 플러스인지, 같은 날 다른 후보들보다 나았는지 등을 함께 보고, 남은
              조건이 있으면 진행바 아래에 <b>&ldquo;남은 조건&rdquo;</b>으로 적어 둡니다. 모두 충족하면{" "}
              <b className="text-rose-600 dark:text-rose-400">검증 통과</b> 배지가 붙고 관리자가 확인 후
              적용합니다.
            </p>
            <p>
