...
export const metadata: Metadata = {
  ...
  title: { absolute: "오늘의 추천 종목 | 종가랩" },
  description:
    "수급(기관·외국인 매수)·차트·뉴스를 보고 매 거래일 자동으로 고른 추천 종목이에요. 왜 골랐는지, 지난 추천은 실제로 어땠는지도 함께 볼 수 있어요.",
 ...
 * 지표가 픽 목록 **위**인 이유는 아래에 두면 카드 10장을 스크롤해야 지수·섹터가 나오기
 * 때문이고, 칩 **한 줄**인 이유는 그래도 추천이 첫 화면을 유지해야 하기 때문이다.
 *
