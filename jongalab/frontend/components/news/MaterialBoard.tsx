 ...
 *
 * 등급으로 미리 갈라 놓으면 실측상 절반 이상이 '판정 보류·중립'으로 떨어져(2026-07-31 36건 중
 * 19건, 07-28 은 18건 전부) 가장 큰 그룹이 "판정 못 함"이 되고, 사용자가 원하는 축(뉴스가 많이
 * 뜬 순 / 많이 오른 순 / 실적 재료만)으로는 아예 볼 수가 없다. 그래서 그룹핑을 **필터·정렬로
 * 바꾼다** — 기본은 뉴스가 많이 뜬 순이고, 등급은 칩으로 좁힌다.
 *
