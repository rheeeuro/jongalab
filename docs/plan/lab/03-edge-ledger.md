...
- **과적합(다중 가설)**: 사전 등록 원칙 + 게이트(평균수익>0·거래일≥10·ci_low>0)로 방어.
  (월 승격 상한은 2026-08-05, 대조군 우위는 2026-08-04 에 각각 폐지 — 근거는 `routers/edge_rule.py` 상단·`core/config.py` EDGE_PROMO_POLICY 주석.)
